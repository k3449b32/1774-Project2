...
print(type(circuit1.conductors["Partridge"])) # Expected output: <class ‘Bus.Bus’>
...
print(type(circuit1.bundles["Bundle 1"]))
print(circuit1.bundles["Bundle 1"].name, circuit1.bundles["Bundle 1"].num_conductors, circuit1.bundles["Bundle 1"].spacing,
    ...
    # Expected Output: "Bundle 1" 2 1.5 "Partridge" 0.05500493461179487 0.06107080982929918

circuit1.add_Geometry("Geometry 1", 0, 0, 50, 0, 25, 30)
print(type(circuit1.geometry["Geometry 1"]))
