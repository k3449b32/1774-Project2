...
circuit1.add_generator_element("Generator 1", circuit1.buses["Bus1"].name, circuit1.buses["Bus1"].base_kv, circuit1.buses["Bus1"].vpu)
...
mismatch_vector = circuit1.compute_power_mismatch(circuit1.buses, circuit1.ybus)

# Print power mismatches
